...
newtype Fake m a = Fake { runFake :: ReaderT FakeState m a }
             deriving (Functor, Applicative, Monad, MonadIO, MonadReader FakeState, MonadCatch, MonadThrow, MonadTrans, MonadBase b)
